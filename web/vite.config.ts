...
export default defineConfig({
  ...
  test: {
    ...
    // under e2e/ and e2e-nightly/ (issue #29's nightly full-scale suite);
    // both are driven by `npx playwright test`, not Vitest (they import
    // @playwright/test and launch a real browser), so keep them out.
    exclude: [...configDefaults.exclude, 'e2e/**', 'e2e-nightly/**'],
  },
})
