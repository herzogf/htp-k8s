  ...
  return (
    <div className="scene-root">
      <Canvas camera={{ position: [10, 9, 15], fov: 50 }}>
        {/* The Provider lives inside <Canvas> so the shared FocusController
            reaches the 3D children (the clickable Towers/Panels and the camera
            rig that consumes their clicks), which are in R3F's own tree. */}
