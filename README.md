...
gh attestation verify htp-k8s_0.3.0_linux_amd64.tar.gz --repo herzogf/htp-k8s

# the container image (the tag resolves to the multi-arch index)
gh attestation verify oci://ghcr.io/herzogf/htp-k8s:v0.3.0 --repo herzogf/htp-k8s
```
