...
Stable releases also publish moving tags (`latest`, `vX`, `vX.Y`) as a **pull convenience, not a verification target** — the digest-pinning note above applies doubly here. Resolve, then verify that:
