...
const (
	...
	DeltaPanelBlink SceneDeltaType = "panelBlink"
)
...
const (
	...
	ActivityPhaseChange PanelActivity = "phaseChange"
	...
	ActivityRestart PanelActivity = "restart"
	...
	ActivityEvent PanelActivity = "event"
)
...
type SceneDelta struct {
	...
	Activity PanelActivity `json:"activity,omitempty"`
}
